          ...
          <div className="row">
            <article className="best-post">
              ...
              <div className="best-post-content">
                <div className="best-post-content-title">Welcome To Triog</div>
                <div className="best-post-content-sub">
                  Triog is a web3 bloging platform Lorem ipsum dolor sit amet
                  consectetur adipisicing elit. Rem atque repellendus
                  voluptatibus eius sapiente ipsa reiciendis molestiae nihil
                  dicta dolorem commodi quis nobis esse minus temporibus sequi,
                  id earum quibusdam.
                </div>
              </div>
            </article>
